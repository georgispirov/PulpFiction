...
$manager = new \PulpFiction\core\EventBuilder\EventHandler();
$manager->attach('something', function (\PulpFiction\core\EventBuilder\Event $event) {
    print_r($event->getParams());
});

$manager->trigger('something', ['a', 'b']);